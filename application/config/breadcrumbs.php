...
$config['tag_open'] = '<ul class="m-subheader__breadcrumbs m-nav m-nav--inline d-flex">';
$config['tag_close'] = '</ul>';
...
$config['frontend_tag_open'] = '<ul class="breadcrumbs" vocab="http://schema.org/">';
$config['frontend_tag_close'] = '</ul>';
$config['frontend_crumb_open'] = '<li property="itemListElement">';
$config['frontend_crumb_last_open'] = '<li property="itemListElement" class="active">';
