<header>
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark pl-4">
            ...
            <?php echo returnLink('navbar-brand logo d-block d-md-none', base_url(), ''); ?>ACMATVIRUS</a>
                    ...
                    <div class="row bg-dark m-0">
                        <div class="col-12 col-md-8">
                            <nav class="navbar navbar-expand-lg navbar-dark">
                                <?php echo returnLink('navbar-brand logo d-none d-md-block', base_url(), ''); ?>ACMATVIRUS</a>
