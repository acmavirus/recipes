<?php
	// General
	$moxieManagerConfig['general.license'] = 'EPHX-PROD-23RJ-SDF9-345K-FSD0-KER4-2I62';
	$moxieManagerConfig['general.hidden_tools'] = 'create';
	$moxieManagerConfig['general.disabled_tools'] = 'create';
	$moxieManagerConfig['general.plugins'] = 'Uploaded, Favorites, AutoRename'; // 'AutoFormat,AutoRename,Dropbox,Favorites,Ftp,GoogleDrive,History,Uploaded';
	$moxieManagerConfig['general.demo'] = false;
	$moxieManagerConfig['general.debug'] = true;
	$moxieManagerConfig['general.language'] = 'fr_FR';
	...
	$moxieManagerConfig['filesystem.exclude_directory_pattern'] = '/^(mcith|dfiles)$/i';
	$moxieManagerConfig['filesystem.include_file_pattern'] = '';
	$moxieManagerConfig['filesystem.exclude_file_pattern'] = '';
	$moxieManagerConfig['filesystem.extensions'] = 'jpg,jpeg,png,gif,html,htm,txt,docx,doc,zip,pdf,mp4,xls,xlsx,ppt,pptx,pps,ppsx';
	...
	$moxieManagerConfig['SessionAuthenticator.logged_in_key'] = 'adminContenu';
	$moxieManagerConfig['SessionAuthenticator.user_key'] = 'user';
	$moxieManagerConfig['SessionAuthenticator.config_prefix'] = 'moxiemanager';

	// IpAuthenticator
	$moxieManagerConfig['IpAuthenticator.ip_numbers'] = '192.168.1.1-192.168.1.255,127.0.0.1,109.0.189.182,82.227.198.101,37.187.127.95,128.79.84.42,37.187.19.206,193.251.90.133,37.187.97.198';
